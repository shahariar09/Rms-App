...
@Component({
  selector: 'app-rent-and-utility-bill-report',
  templateUrl: './rent-and-utility-bill-report.component.html',
  styleUrls: ['./rent-and-utility-bill-report.component.css']
})
export class RentAndUtilityBillReportComponent implements OnInit {
  ...
  viewPdfReport() {
    ...
    this._service
    .RentAndUtilityBillReport(this.filterForm.value.customerId,this.filterForm.value.month).subscribe(
      (blobData: Blob) => {
